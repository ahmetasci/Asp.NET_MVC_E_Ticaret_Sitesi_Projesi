namespace KitapSitesi.Models
{
    ...
    public partial class ProjeDatabase : DbContext
    {
        public ProjeDatabase()
            : base("name=ProjeDatabase5")
        {
        }
        ...
        public virtual DbSet<FavoriKitaplar> FavoriKitaplars { get; set; }
        ...
        public virtual DbSet<Magazalar> Magazalars { get; set; }
